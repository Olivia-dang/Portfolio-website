    ...
    <div>
      ...
      <div class="container">
          ...
          <ul class="no-bullet">
            <li>
              <a href="https://twitter.com/OliviaDang11">
                ...
                twitter.com/OliviaDang11
              </a>
            </li>
            <li>
              <a href="https://github.com/Olivia-dang">
                <svg
        ...
        <section class="col-50">
          <ul class="no-bullet">
            <li>
              <a href="https://www.linkedin.com/in/oliviaphuonganh/">
                <svg
                  class="icon icon-twitter"
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                ...
                linkedin.com/in/oliviaphuonganh/
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/olivia_pad1">
                <svg
      ...
      <p class="quote">
        ...
        <span class="inline-together">– Henry Ford</span>
      </p>
