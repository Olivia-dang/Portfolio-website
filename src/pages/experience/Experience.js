    ...
    <div>
      ...
      <div>
        ...
        <div className="experience-container">
          <section className="experience-row">
            ...
            <article className="col-70">
              ...
              <ul>
                ...
                <li>Evaluated functionality and accessibility of Web Pages.</li>
                <li>
              ...
              <p className="company-link">
                <LinkIcon />
                <a href="https://coderacademy.edu.au/">coderacademy.edu.au/</a>
              </p>
            </article>
          </section>
          <section className="experience-row">
            <div className="col-30">
              <h4 className="company-name">Twenty Tech | IT outsourcing company</h4>
            ...
            <article className="col-70">
              ...
              <ul>
                <li>
                  ...
                  requirements for website/software development to provide quote
                  estimation thereof.
                </li>
                <li>
                ...
                <li>
                  Team management: gave training and instructions for the team.
                  Be an inspiring leader to drive the team to organizational
                  objectives.
                </li>
              </ul>
              <p className="company-link">
          ...
          <section className="experience-row">
            <div className="col-30">
              <h4 className="company-name">CMC Global | IT outsourcing company</h4>
            ...
            <article className="col-70">
              ...
              <ul>
                ...
                <li>
                  ...
                  customer orders, dealing with requests and relevant problems.
                </li>
              </ul>
              <p className="company-link">
                <LinkIcon />
